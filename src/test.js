	...
	describe('document', function() {
	  ...
	  return describe('#createElement()', !function() {
	    ...
	    it('should be of class Element', !function() {
	      return e.constructor.displayName.should.eql('Element');
	    });
	    it('should have a div tagname', !function() {
	      return e.tagname.should.eql('div');
	    });
	    return it('should have the correct owner document', !function() {
	      return e.ownerDocument.should.eql(document);
	    });
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {// Generated by LiveScript 1.5.0
	...
	ref$ = __webpack_require__(42), first = ref$.first, last = ref$.last, reject = ref$.reject, find = ref$.find, Obj = ref$.Obj;
	nsIURI = (function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	Func = __webpack_require__(43);
	List = __webpack_require__(44);
	Obj = __webpack_require__(45);
	Str = __webpack_require__(46);
	Num = __webpack_require__(47);
	id = function(x){
	  return x;
	};
