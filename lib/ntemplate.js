...
var _nudist = require('./nudist');

var _nudist2 = _interopRequireDefault(_nudist);
...
new _nudist2.default(_parasite2.default);
new _nudist2.default(_alchemist2.default);

_nudist2.default.expose(_nudist2.default);